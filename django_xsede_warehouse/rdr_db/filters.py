...
###############################################################################
# Active Resource Filtering Criteria
#
...
def RDR_Active_Sub_ResourceIDs(level=None):
    # Active base resources
    if level == 'xup' or level is None:
...
def RDR_Active_Sub_Resources(level=None):
    # Active base resources
    if level == 'xup' or level is None:
        base_resources = RDRResource.objects.filter(
                                             Q(rdr_type='resource') &
...
def RDR_Active_All_ResourceIDs(level=None):
    if level == 'xup' or level is None:
        base_resources = RDRResource.objects.filter(
                                             Q(rdr_type='resource') &
                                             Q(other_attributes__project_affiliation='XSEDE') &
...
def RDR_Active_All_Resources(level=None):
    if level == 'xup' or level is None:
        base_resources = RDRResource.objects.filter(
                                             Q(rdr_type='resource') &
                                             Q(other_attributes__project_affiliation='XSEDE') &
