...
# from monitoring_db.models import EntityHistory
from monitoring_provider.process import Glue2NewDocument
...
#       pdb.set_trace()
        ...
        pa = ProcessingActivity('monitoring_provider.views', 'Glue2ProcessDoc', pa_id, doctype, resourceid)
