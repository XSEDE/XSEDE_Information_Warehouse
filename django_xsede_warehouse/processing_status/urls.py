...
urlpatterns = [
    ...
    url(r'^record/resourceid/(?P<resourceid>[^/]+)/$', ProcessingRecord_DbList.as_view(), name='processingrecord-dblist-byresourceid'),
    url(r'^record/id/(?P<id>[^/]+)/$', ProcessingRecord_Detail.as_view(), name='processingrecord-detail'),
    url(r'^record/latest/(resourceid|about)/(?P<about>[^/]+)/$', ProcessingRecord_LatestList.as_view(), name='processingrecord-latestlist-byabout'),
