...
ALTER ROLE django_owner WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION PASSWORD 'monkeypass';
ALTER ROLE django_owner SET search_path TO django;

CREATE ROLE glue2_owner;
ALTER ROLE glue2_owner WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION PASSWORD 'monkeypass';
