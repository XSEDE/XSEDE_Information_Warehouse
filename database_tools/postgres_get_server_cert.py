#!/usr/bin/env python
#
# Used by JP on 2019-11-27 during information-warehouse-prod certificate upgrade
#
# Usage:
#   ./postgres_get_server_cert.py <rds_hostname>:5432|openssl x509 -noout -text
# 
# From: https://github.com/thusoy/postgres-mitm/blob/master/postgres_get_server_cert.py
#
